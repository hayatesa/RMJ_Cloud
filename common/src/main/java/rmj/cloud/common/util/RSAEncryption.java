package rmj.cloud.common.common.util;
...
public class RSAEncryption {
    ...
    public static void main(String[] args) throws Exception {
        Map<String, String> keyMap = RSAEncryption.createKeys(1024);
